...
import { Skill, CATEGORIES } from "@/data/skills";
...
export default function SkillsClient({ skills, lastUpdated, sourceNames }: SkillsClientProps) {
  ...
  }, [skills, search, secFilter, catFilter, sourceFilter, sortBy]);
    ...
    <div>
      <div className="mb-7">
        ...
        <p className="text-sm text-text-secondary">
          {sourceNames} — all skills in one place. Security verified.
        </p>
      </div>
