...
export interface Skill {
  ...
  name: string;
  desc: string;
  /** Primary source (backward-compatible) */
  source: string;
  /** All sources where this skill is available */
  sources?: SourceRef[];
  /** GitHub repository URL (for install/link) */
  githubUrl?: string;
  installs: number;
  rating: number;
  reviews: number;
...
export const SKILLS: Skill[] = [
  ...
  // === Productivity (5) ===
  { id: 2, slug: "google-calendar", name: "google-calendar", desc: "Manage Google Calendar events, reminders, and scheduling", source: "ClawHub", sources: [{ sourceId: "clawhub" }, { sourceId: "awesome-openclaw-skills" }], githubUrl: "https://github.com/openclaw/google-calendar", installs: 9520, rating: 4.8, reviews: 189, security: "verified", category: "productivity", permissions: ["api-key"], platforms: ["OpenClaw"], virustotal_status: "clean", protocols: ["MCP", "REST"], lastUpdated: "2026-02-08", maintainerActivity: "active" },
  ...
  { id: 35, slug: "prompt-injector-detector", name: "prompt-injector-detector", desc: "Detect and block prompt injection attacks in real-time", source: "GitHub", sources: [{ sourceId: "github" }, { sourceId: "awesome-openclaw-skills" }, { sourceId: "clawhub" }], githubUrl: "https://github.com/openclaw-security/prompt-injector-detector", installs: 4500, rating: 4.8, reviews: 96, security: "verified", category: "agent", permissions: ["network"], platforms: ["OpenClaw", "Claude Code", "Codex"], virustotal_status: "clean", protocols: ["MCP", "A2A"], lastUpdated: "2026-02-12", maintainerActivity: "active" },
  ...
  // === Visualize (6) ===
  { id: 54, slug: "chart-image", name: "chart-image", desc: "Generate chart PNGs locally using Vega-Lite — 9 chart types, dark mode, no API key required", source: "ClawHub", sources: [{ sourceId: "clawhub" }, { sourceId: "awesome-openclaw-skills" }, { sourceId: "openclawskill" }], githubUrl: "https://github.com/dannyshmueli/chart-image", installs: 5800, rating: 4.7, reviews: 124, security: "verified", category: "visualize", permissions: ["file"], platforms: ["OpenClaw", "Claude Code"], virustotal_status: "clean", protocols: ["MCP"], lastUpdated: "2026-02-14", maintainerActivity: "active" },
  ...
  { id: 57, slug: "mermaid-diagram", name: "mermaid-diagram", desc: "Create Mermaid.js diagrams — flowcharts, sequence, Gantt, class, ER, and state diagrams from text", source: "GitHub", sources: [{ sourceId: "github" }, { sourceId: "awesome-openclaw-skills" }, { sourceId: "clawhub" }], githubUrl: "https://github.com/openclaw-community/mermaid-diagram", installs: 3400, rating: 4.4, reviews: 65, security: "reviewed", category: "visualize", permissions: ["file"], platforms: ["OpenClaw", "Claude Code", "Codex"], virustotal_status: "clean", protocols: ["MCP"], lastUpdated: "2026-02-08", maintainerActivity: "active" },
  ...
  // === New skills (Sprint 7 — Feb 2026 Research) ===
  { id: 60, slug: "sandbox-runner", name: "sandbox-runner", desc: "Execute untrusted code in Firecracker microVM sandboxes — sub-200ms boot, isolated kernel, auto-cleanup", source: "ClawHub", installs: 4800, rating: 4.7, reviews: 102, security: "verified", category: "agent", permissions: ["network", "shell"], platforms: ["OpenClaw", "Claude Code"], virustotal_status: "clean", protocols: ["MCP", "REST"], lastUpdated: "2026-02-17", maintainerActivity: "active" },
  { id: 61, slug: "a2a-bridge", name: "a2a-bridge", desc: "Bridge MCP skills to Google A2A protocol — enable agent-to-agent collaboration with signed security cards", source: "ClawHub", installs: 3200, rating: 4.5, reviews: 68, security: "verified", category: "agent", permissions: ["network"], platforms: ["OpenClaw", "Claude Code", "Codex"], virustotal_status: "clean", protocols: ["MCP", "A2A"], lastUpdated: "2026-02-15", maintainerActivity: "active" },
  { id: 62, slug: "secret-vault-wrapper", name: "secret-vault-wrapper", desc: "Pull secrets from HashiCorp Vault, AWS Secrets Manager, or 1Password instead of static config files", source: "ClawHub", installs: 3600, rating: 4.6, reviews: 77, security: "verified", category: "utility", permissions: ["api-key", "network"], platforms: ["OpenClaw", "Claude Code"], virustotal_status: "clean", protocols: ["MCP", "REST"], lastUpdated: "2026-02-16", maintainerActivity: "active" },
  { id: 63, slug: "agent-observability", name: "agent-observability", desc: "Datadog-compatible tracing, logging, and metrics for agent workflows — track latency, errors, and cost per task", source: "ClawHub", installs: 2900, rating: 4.4, reviews: 56, security: "verified", category: "agent", permissions: ["network"], platforms: ["OpenClaw", "Claude Code"], virustotal_status: "clean", protocols: ["MCP", "REST"], lastUpdated: "2026-02-14", maintainerActivity: "active" },
  { id: 64, slug: "skill-signature-verifier", name: "skill-signature-verifier", desc: "Verify cryptographic signatures on skill packages before installation — prevent supply chain attacks", source: "GitHub", sources: [{ sourceId: "github" }, { sourceId: "clawhub" }, { sourceId: "awesome-openclaw-skills" }], githubUrl: "https://github.com/openclaw-security/skill-signature-verifier", installs: 2400, rating: 4.8, reviews: 51, security: "verified", category: "utility", permissions: ["file", "network"], platforms: ["OpenClaw", "Claude Code", "Codex"], virustotal_status: "clean", protocols: ["MCP"], lastUpdated: "2026-02-17", maintainerActivity: "active" },
  { id: 65, slug: "playwright-web", name: "playwright-web", desc: "LLM-driven web interaction via Playwright accessibility tree — 27K+ stars, the most popular browser skill", source: "ClawHub", sources: [{ sourceId: "clawhub" }, { sourceId: "awesome-openclaw-skills" }, { sourceId: "moltbooks" }, { sourceId: "openclawskill" }], githubUrl: "https://github.com/microsoft/playwright-mcp", installs: 15200, rating: 4.8, reviews: 312, security: "verified", category: "browser", permissions: ["network", "shell"], platforms: ["OpenClaw", "Claude Code", "Codex"], virustotal_status: "clean", protocols: ["MCP"], lastUpdated: "2026-02-16", maintainerActivity: "active" },
];
